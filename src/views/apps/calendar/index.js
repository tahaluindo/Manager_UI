...
function App() {
  ...
  const [columnDefs] = useState([
    ...
    { headerName: 'Shift Name', field: 'shiftName' },
    { headerName: 'Starting Time', field: 'startingTime' },
    { headerName: 'Ending Time', field: 'endingTime', suppressSizeToFit: true },
    { headerName: 'Total Hours', field: 'totalHourse' },
  ...
  useEffect(() => {
    fetch(`http://122.166.2.21:14888/getAttendantShift?hotelID=${id}`)
